...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LSFT,        LCTL_T(KC_Z), KC_X,    KC_C,    KC_V,         KC_B,           MT(MOD_HYPR, KC_ENTER),                       MT(MOD_HYPR, KC_ENTER), KC_N, KC_M,     KC_COMMA,    KC_DOT,      RCTL_T(KC_SLASH), KC_RSHIFT,
    LT(1,KC_GRAVE), KC_SPC,       KC_LEAD, KC_LALT, LT(3,KC_END),                                                                                             KC_EQUAL, KC_LBRACKET, KC_RBRACKET, KC_TRNS,   MO(1),
                                                                                      TG(2),         TG(1),                     KC_LOCK,   LCTL_T(KC_ESC),
                                                                                                     KC_HOME,                   KC_PGUP,
                                                                      LGUI_T(KC_SPC), LT(4, KC_ESC), LT(3,KC_END),              KC_PGDOWN, LT(4, KC_ESC),  KC_SPC
  ),
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRNS,   KC_PERC,        KC_CIRC,        KC_LBRACKET,    KC_RBRACKET,    KC_TILD,        KC_TRNS,                                 KC_TRNS, KC_AMPR,        KC_1,           KC_2,           KC_3,           KC_BSLASH,      KC_TRNS,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRNS, KC_TRNS, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MEDIA_PLAY_PAUSE,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                 KC_TRNS, KC_TRNS, KC_TRNS, KC_MEDIA_PREV_TRACK,KC_MEDIA_NEXT_TRACK,KC_TRNS, KC_TRNS,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                                                                                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                                                                                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                                                                                                    KC_TRNS, KC_PGUP,
                                                                                    KC_TRNS, KC_TRNS, KC_TRNS, KC_PGDOWN,      KC_TRNS, KC_TRNS
  ...
  [4] = LAYOUT_ergodox_pretty(
    ...
    KC_TRNS,  KC_TRNS,    KC_LBRC,       GH_ELIXIR_PIPE, KC_RBRC,        KC_BSLASH,  KC_TRNS,                                            KC_TRNS, KC_LBRC,       KC_LCBR,       KC_UNDERSCORE, KC_RCBR,        KC_RBRC,     GH_ELIXIR_PIPE,
